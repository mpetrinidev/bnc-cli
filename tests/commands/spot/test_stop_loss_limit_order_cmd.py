...
@pytest.mark.parametrize("params", [
    ['spot', 'new_order', 'stop_loss_limit', '-sy', 'LTCBTC', '-si', 'SELL', '-tif', 'GTC', '-q', 1, '-p', 0.0060, '-sp', 0.0050],
    ['spot', 'new_order', 'stop_loss_limit', '--symbol', 'LTCBTC', '--side', 'SELL', '--time_in_force', 'GTC',
     '--quantity', 1, '--price', 0.0060, '--stop_price', 0.0050],

    ['spot', 'new_order', 'stop_loss_limit', '-sy', 'LTCBTC', '-si', 'SELL', '-tif', 'GTC', '-q', 1, '-p', 0.0060, '-sp', 0.0050, '-ncoid', 'custom_id'],
    ['spot', 'new_order', 'stop_loss_limit', '--symbol', 'LTCBTC', '--side', 'SELL', '--time_in_force', 'GTC',
     '--quantity', 1, '--price', 0.0060, '--stop_price', 0.0050, '--new_client_order_id', 'custom_id'],

    ['spot', 'new_order', 'stop_loss_limit', '-sy', 'LTCBTC', '-si', 'SELL', '-tif', 'GTC', '-q', 1, '-p', 0.0060, '-sp', 0.0050, '-iq', 0.5],
    ['spot', 'new_order', 'stop_loss_limit', '--symbol', 'LTCBTC', '--side', 'SELL', '--time_in_force', 'GTC',
...
@pytest.mark.parametrize("params", [
    ['spot', 'new_order', 'stop_loss_limit', '-sy', 'LTCBTC', '-si', 'SELL', '-tif', 'GTC', '-q', 1, '-p', 0.0060, '-sp', 0.0050, '-nort', 'FULL'],
    ['spot', 'new_order', 'stop_loss_limit', '--symbol', 'LTCBTC', '--side', 'SELL', '--time_in_force', 'GTC',
...
@pytest.mark.parametrize("params", [
    ['spot', 'new_order', 'stop_loss_limit', '-sy', 'LTCBTC', '-si', 'SELL', '-tif', 'GTC', '-q', 1, '-p', 0.0060, '-sp', 0.0050, '-nort', 'RESULT'],
    ['spot', 'new_order', 'stop_loss_limit', '--symbol', 'LTCBTC', '--side', 'SELL', '--time_in_force', 'GTC',
